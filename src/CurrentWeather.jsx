...
const CurrentWeather = ({ loc, weather, handleRemoveLocation }) => {
  ...
  return (
    <div className="location-info">
      ...
      <div className="remove-location">
        <button className="remove-location__button" onClick={(e) => handleRemoveLocation(e, loc)}>Remove location</button>
      </div>
    </div>
  )
};
